...
CREATE TABLE `file_approvals` (
  ...
  `nbi_is_approved` tinyint NOT NULL DEFAULT '0',
  `nbi_approval_date` timestamp NULL DEFAULT NULL,
  `medical_is_approved` tinyint NOT NULL DEFAULT '0',
  `medical_approval_date` timestamp NULL DEFAULT NULL,
  `tesda_is_approved` tinyint NOT NULL DEFAULT '0',
  `tesda_approval_date` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `file_approvals` VALUES (9,72,1,'2024-12-05 17:06:46',1,'2024-12-05 17:06:48',1,'2024-12-05 17:06:50',1,'2024-12-05 17:06:51','resume',0,NULL,0,NULL,0,NULL),(21,73,1,'2024-12-05 11:49:23',1,'2024-12-05 11:49:25',1,'2024-12-05 11:49:26',1,'2024-12-05 11:49:29','resume',0,NULL,0,NULL,0,NULL);
